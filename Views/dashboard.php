        ...
        <div class="contenedor-principal flex-grow-1" id="container-principal">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2 class="fw-bold">Preguntas</h2>
                    <button class="btn btn-primary d-md-none" data-bs-toggle="modal" data-bs-target="#addForumModal">
                        <i class='bx bx-plus me-1'></i> Nueva pregunta
                    </button>
                </div>
